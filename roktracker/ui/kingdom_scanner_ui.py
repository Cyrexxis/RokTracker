...
class KingdomScannerUI(ttk.Frame):
    def __init__(self, master: Any, app_config: AppConfig):
        ...
        self.start_button.grid(row=1, column=1, padx=10, pady=10, sticky="ew")

        self.stop_button = ttk.Button(
            self, text="Stop scan", command=self.stop_scan, state="disabled"
        )
        self.stop_button.grid(row=1, column=2, padx=10, pady=10, sticky="ew")

        self.current_state = ttk.Label(self, text="Not started")
