...
required_version = (3, 11) # Replace with the required version tuple, e.g., (3, 9) for Python 3.9
current_version = sys.version_info

if current_version < required_version:
    print(f"Update required: Current Python version is {current_version.major}.{current_version.minor} "
